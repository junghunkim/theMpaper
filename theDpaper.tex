...
stochastic marked Poisson process which is comprised of $n(n-1)/2$ single-channel doubly stochastic marked Poisson process that are conditionally mutually independent Poisson process 
given the information process.  In particular,  
